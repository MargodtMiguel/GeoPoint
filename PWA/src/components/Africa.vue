...
<path @click="pickCountry('BI')" id="BI" class="st0" d="M679.2,578.4l-0.6-5.4l0,0l-6.5-0.9l-3.8,7.9l-7.4-1.1l3,6.3l0.1,2.4
	l4.3,13.2v0.6l1.2-0.2l4.5-5l4.9-7.2l3-2.9l-0.1-4.5L679.2,578.4L679.2,578.4z"/>
<path @click="pickCountry('BJ')" id="BJ" class="st0" d="M350.2,378.3l-9.3-8l-4.3,0.1l-4.1,4l-2.6,4.2l-6,1.2l-2.5,6.1
...
<path @click="pickCountry('BF')" id="BF" class="st0" d="M310.9,333.1h-7.8l-3-2.6l-6.7,1.9l-11.3,5.8l-2.3,4.3l-9.4,6.2
...
<path @click="pickCountry('BW')" id="BW" class="st0" d="M610.8,785l-2.2-1l-6.9,3.1h-3.6l-7.9,5.4l-4.4-5.7l-18.7,4.9l-9,0.4
...
<path @click="pickCountry('CF')" id="CF" class="st0" d="M597.2,420.4l-1-0.7l-4.2-4l-0.9-4.3l1.9-5.7l-0.1-5.7l-7.2-8.6
...
<path @click="pickCountry('CI')" id="CI" class="st0" d="M240.6,396.1l-5,2.1l-2.9,1.7l-1.8-5.9l-3.5,1.6l-2.1-0.3l-2.3,4
...
<path @click="pickCountry('CM')" id="CM" class="st0" d="M487.7,388.9l0.4-9.2l-1-9.1l-4.9-8.9l-3.4,0.8l-0.4,4.4l4.9,5.5
...
<path @click="pickCountry('CD')" id="CD" class="st0" d="M628.5,468.3l-9.2-1.4l-4.5,1.2l-1.8,3.3l-3.9,0.5l-4.9-3l-13.5,6.9
...
<path @click="pickCountry('CG')" id="CG" class="st0" d="M531.7,491.1l-7.9-0.7l-8.2-2.4l-7.3,7.4l-6.3,12.8l-0.9,7.5
...
<path @click="pickCountry('DJ')" id="DJ" class="st0" d="M830.5,381l-5.3-3.8l6.8-3.3l0.1-5.7l-3-4.3l-3.6,3.4l-5.2-1.2
	l-4,6.1l-3.9,6.5l1.1,3.8l0.3,4.2l6.8,0.2l2.9-0.9l2.8,2.4L830.5,381L830.5,381z"/>
<path @click="pickCountry('DZ')" id="DZ" class="st0" d="M402.6,28l-7.8,0.8l-4.8-3.2l-12.2,0.1l-10.6,5.5l-5.8-2.1l-18.9,1.2
...
<path @click="pickCountry('EG')" id="EG" class="st0" d="M639,110.4l-11.9-4l-11.5-3.7l-15.6,0.2l-3.7,6.6l2.2,5.9l-2.4,8.5
...
<path @click="pickCountry('ER')" id="ER" class="st0" d="M787.8,326.1l-7-6.8l-4-12.7l-7.8-16l-5.7,7.9l-8.8,2.3l-3.6,4.2
...
<path @click="pickCountry('ET')" id="ET" class="st0" d="M765,332.6l-3.3,10.4l-14.3-2.9L746,352l-4.5,13.6l-7.1,6.8
...
<path @click="pickCountry('GA')" id="GA" class="st0" d="M466.1,508.2l-1.5-0.7l-7.3,1.8l-7.4-1.9l-5.8,0.9l0.1,16.7
...
<path @click="pickCountry('GH')" id="GH" class="st0" d="M306.6,387.2l-5.6-1.1l-3.9,2.2l-5.4-1l-21.1,0.6l-0.3,7.9l1.6,10.4
...
<path @click="pickCountry('GN')" id="GN" class="st0" d="M166.6,367.5l-1.8,0.7l-6.6-1.1l-0.9,1.6l-2.7,0.3l-8.7-3.4l-5.8-0.1
...
<path @click="pickCountry('GM')" id="GM" class="st0" d="M102.1,357.7l11,0.2l3-1.9l2.2-0.1l4.5-3.2l5.2,2.9l5.2,0.3l5.3-3.1
	l-2.4-4l-4,2.3l-3.8-0.1l-4.7-3.4l-3.8,0.2l-2.8,3.3l-13.2,0.4L102.1,357.7L102.1,357.7z"/>
<path @click="pickCountry('GW')" id="GW" class="st0" d="M140.1,365.5l-22.4-0.6l-3.3,1.6l-4-0.5l-6.5,2.3l0.7,2.9l3.7,3
	l-0.1,2.1l2.7,3.9l5.1,0.9l6.4,5.8l5.5-6.8l3.7,0.3l3.2-2.3l2.7-0.1l1.9-1.8l-0.9-4.6l1.3-1.4L140.1,365.5L140.1,365.5z"/>
<path @click="pickCountry('GQ')" id="GQ" class="st0" d="M444.1,508.3l-19.9-0.3l-4.1,15.5l2.2,2.1l4.2-0.8l17.7,0.2
	L444.1,508.3L444.1,508.3z"/>
<path @click="pickCountry('KE')" id="KE" class="st0" d="M817.4,485.4H809l-4.9-4.7l-11.1,5.8l-3.5,5.8l-8.2-1.1l-2.7-1.6
...
<path @click="pickCountry('LR')" id="LR" class="st0" d="M203.5,433.3l-3.4-0.4l-2.6,5.6l-3.4-0.1l-2.4-2.9l0.9-5.6l-5.1-8.5
...
<path @click="pickCountry('LY')" id="LY" class="st0" d="M600,102.9l-3.1-4.5l-11.7-1.6l-3.9-2.4h-4.4l-4.4-6.2l-15.9-2.8
...
<path @click="pickCountry('LS')" id="LS" class="st0" d="M635.5,962.2l2.5-4.4l6.7-2.2l2.4-4.5l4.1-6.7l-3.8-4.2l-4.8-4.2
	l-5.7,2.8l-6.8,5.4l-6.9,8.7l8,10.6L635.5,962.2L635.5,962.2z"/>
<path @click="pickCountry('MA')" id="MA" class="st0" d="M281.4,53l-5-0.1l-11.9-3.1l-11,0.9l-6.8-5.9l-8.5-0.1l-3.8,8.6
...
<path @click="pickCountry('MG')" id="MG" class="st0" d="M913.1,727.1l-2.5-9.1l-3-5.9l-3.9-5.9l-4.3,6.2l-0.7,8.3l-7.1,9.6
...
<path @click="pickCountry('ML')" id="ML" class="st0" d="M357.6,274.6l-13.3,1.3l-0.2-8.8l-5.5-2.2l-7.5-4l-2.9-6.4
...
<path @click="pickCountry('MZ')" id="MZ" class="st0" d="M798.4,688.5l-1.7-6.2l0,0l0,0l-10,8.1l-13.4,5.3l-7.3-0.2l-4.5,4.2
...
<path @click="pickCountry('MR')" id="MR" class="st0" d="M247.8,194.1l-44.1-33.5l-0.5,20.9l-38.9-0.7l-0.4,35.4l-11.2,1.3
...
<path @click="pickCountry('MW')" id="MW" class="st0" d="M724.8,734l0.3-5.2l-2.7-4.1l0.4-6l-3.3-10.2l3.7-7.7l-0.2-16.7
...
<path @click="pickCountry('NA')" id="NA" class="st0" d="M586.2,782l-22.4,5.7l-29.1-2l-8.2-6.6l-48.8,0.6l-1.9,1l-7.1-6.3
...
<path @click="pickCountry('NE')" id="NE" class="st0" d="M468.5,220.9l-19-6L409,241.3l-34.5,27.1l-16.9,6.2l0.3,31.9
...
<path @click="pickCountry('NG')" id="NG" class="st0" d="M478.4,366.9l-2.2,0.3l-8.4-15.1l-2.9-0.6l-9.4,7.7l-9.4-4l-6.5-0.8
...
<path @click="pickCountry('RW')" id="RW" class="st0" d="M678.1,555.3l-7.4,4.3l-2.9-1.4l-3.5,3.8l-0.5,8.3l-1.7,1l-1.2,7.6
	l7.4,1.1l3.8-7.9l6.5,0.9l0,0l3.5-1.8l0.8-8.1L678.1,555.3L678.1,555.3z"/>
<path @click="pickCountry('EH')" id="EH" class="st0" d="M204,156.9h-1.8l0,0l0.1,7.5l-7.3,0.4l-3.9,3.2h-5.4l-4.2-1.8
...
<path @click="pickCountry('SD')" id="SD" class="st0" d="M750.2,314.2l0.7-9.2l3.6-4.2l8.8-2.3l5.7-7.9l-6.9-5.1l-4.8-3.4
...
<path @click="pickCountry('SS')" id="SS" class="st0" d="M718,401.5l-1.5-4.7l-6.5-5.5l-1.7-10l1.2-10.2l-5.7-0.9l-0.7,3
...
<path @click="pickCountry('SN')" id="SN" class="st0" d="M159,337.4l-7.8-9.5l-7.2-10.2l-7.9-3.7l-5.7-4l-6.8,0.1l-5.9,3
...
<path @click="pickCountry('SL')" id="SL" class="st0" d="M181.7,423.3l-3.3,0.8l0.1-5.1l-1.9-3.6l0.4-4l-2.6-5.8l-3.3-5h-9.7
	...
	"/>
<path @click="pickCountry('SZ')" id="SZ" class="st0" d="M684.2,897.2l-5.8-2.6l-3.5,1l-1.4,4l-3.6,5.2l-0.2,4.8l6.6,7.5
	l7-1.5l2.8-6.1l-0.6-6.1L684.2,897.2L684.2,897.2z"/>
<path  @click="pickCountry('TD')" id="TD" class="st0" d="M592.7,268.7L544,242.2l-48.4-26.5l-11.9,7.6l3.4,21.5l4.6,3.6
...
<path  @click="pickCountry('TG')" id="TG" class="st0" d="M317.3,387.5l-10.7-0.3l-0.9,4.3l5.1,7.1v10.1l1.2,10.9l3,5
	l-2.7,12.5l1,6.8l3.2,8.8l2.8,4.9l9.8-3l-3-9.5l0.5-31.8l-2.5-2.8l-0.4-6.8l-4.3-4.9l-3.7-4.1L317.3,387.5z"/>
<path  @click="pickCountry('TN')" id="TN" class="st0" d="M439.7,81.3l-4.5-2.2l-3.2-6.6l-6-0.2l-2.4-7.6l7.3-7l1.1-12.1
...
<path  @click="pickCountry('TZ')" id="TZ" class="st0" d="M682.4,553.6l-4.3,1.7l4.8,7.8l-0.8,8.1l-3.5,1.8l0,0l0.6,5.4
...
<path  @click="pickCountry('UG')" id="UG" class="st0" d="M721.5,480.8l-7.4,6.4l-8.6-0.1l-9.8,3.3l-7.8-3.1l-5,3.8l0,0
...
<path  @click="pickCountry('ZA')" id="ZA" class="st0" d="M532.5,1021.3l5.3-0.3l7.5-5.3l10-2.2l12.3-5.5l4.7,0.7l7.2-1.7
...
<path  @click="pickCountry('ZM')" id="ZM" class="st0" d="M681.5,658.3l-4.1-1.1l0.7-3l-2.1-0.6l-16.4,2.3l-3.3,1.7l-3.6,8.8
	...
	L681.5,658.3z"/>
<path  @click="pickCountry('ZW')" id="ZW" class="st0" d="M679.3,847.4l13.4-15.7l3.6-9.9l1.9-1.3l1.7-8.1l-1.7-4.1l1-10.4
	...
	L679.3,847.4z"/>
<path  @click="pickCountry('SO')" id="SO"  class="st0" d="M842.8,395.1l-5.7-5.8l-2.5-5.7l-4.1-2.6l-4.2,7.4l-2.5,4.9l4.8,7.7
