...
<div>
  <div class="c-game__top">
    ...
    <div class="c-game__top__controls">
      <svg @click="zoomIn()" class="controlbutton" id="plusbutton" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 31.1 31.1" style="enable-background:new 0 0 31.1 31.1;" xml:space="preserve">
        <g>
          <g>
            <path class="st1" d="M15.5,31.1C7,31.1,0,24.1,0,15.5S7,0,15.5,0s15.5,7,15.5,15.5C31.1,24.1,24.1,31.1,15.5,31.1z M15.5,1.8
              C7.9,1.8,1.8,7.9,1.8,15.5s6.2,13.8,13.8,13.8s13.8-6.2,13.8-13.8S23.1,1.8,15.5,1.8z"/>
          </g>
          <g>
            <path class="st1" d="M23.3,16.6h-15c-0.6,0-1.1-0.5-1.1-1.1c0-0.6,0.5-1.1,1.1-1.1h15c0.6,0,1.1,0.5,1.1,1.1
              C24.4,16.1,23.9,16.6,23.3,16.6z"/>
          </g>
          <g>
            <path class="st1" d="M16.9,8.1v15c0,0.6-0.5,1.1-1.1,1.1c-0.6,0-1.1-0.5-1.1-1.1v-15c0-0.6,0.5-1.1,1.1-1.1
              C16.4,7,16.9,7.5,16.9,8.1z"/>
          </g>
        </g>
      </svg>
      <svg  @click="zoomOut()" version="1.1" class="controlbutton" id="minusbutton" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 31.1 31.1" style="enable-background:new 0 0 31.1 31.1;" xml:space="preserve">
      <g>
        <g>
          <path class="st1" d="M15.5,31.1C7,31.1,0,24.1,0,15.5S7,0,15.5,0s15.5,7,15.5,15.5C31.1,24.1,24.1,31.1,15.5,31.1z M15.5,1.8
...
<div class="c-game__map">
  ...
  <svg id="map" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <path @click="pickCountry('AL')" id="AL" class="st0" d="M518.7,528.1l0.5,0.4l2,2.9l1.4,0.5l1.9,1.3l1.4,3.2l0.1,2.2l-0.5,2.6l0.3,2.1l-0.8,0.8l0.7,2l0.2,1.9
      ...
      L518.7,528.1z"/>
    <path @click="pickCountry('AD')" id="AD" class="st0" d="M287.4,528.8l-2.8,1.1l-0.7-0.4v-2.1l0.9-0.7l2.6,0.6V528.8L287.4,528.8z"/>
    <path @click="pickCountry('AM')" id="AM" class="st0" d="M838.6,572.4l-3.2-2.8l-2.3-1.7l-1.6-0.7l-3.5,0.4l-2.9-0.9l-1.8-0.9l0.5-0.6l-1.9-3l-0.8-1.9l1-1.4
    ...
    <path @click="pickCountry('AT')" id="AT" class="st0" d="M471.8,434.9l-0.9,2.4l0.1,0.8l1.6,2.9l2.3,2.9l-0.6,0.7l-0.6,1.9l0.7,2l-3.9,0.3l-2.5-0.9l-1.3,1.4
      ...
      L471.8,434.9z"/>
    <path @click="pickCountry('BE')" id="BE" class="st0" d="M334,401.8l1.6-0.5l0.8,0.8l1.2,0.1l3,2.3l-0.4,1.5l1.7,0.7l0.4,2L340,410l-0.6,1.7l-1.7-0.7l-1.3,1.3
    ...
    <path @click="pickCountry('BG')" id="BG" class="st0" d="M623.6,509.6l0.2,3.7l-0.9,1.8l-2-0.6l-2.2,0.5l-1,2l-1.2,1.2v2.6l0.4,4.2l-1.6,0.7l-2.9,3.7l3,1.8
    ...
    <path @click="pickCountry('BA')" id="BA" class="st0" d="M502.2,492.2l2.8-0.7l1.5,0.8l-0.5,2.5l-1.6,2.7l-0.1,2.6l0.5,0.8l2.4,1.2l3.3,2.9l-0.3,0.8l-3.1-0.1
    ...
    <path @click="pickCountry('BY')" id="BY" class="st0" d="M588.5,321.5l1.8,1.3l1.2-0.4l1.9-0.1l3.1,2.2l1.6-0.9l1.5-0.3l3.6,1.2l0.2,2.3l1.7,1.5l2.1-1.3
    ...
    <path @click="pickCountry('CH')" id="CH" class="st0" d="M378.1,449.1l0.8,1.1l2.6,1.3h1.2l0.9,0.7l-1,3l-0.5,1.5l0.1,1.7l1.2,0.1l3.3,0.8l0.4,1l1.5,0.8
      ...
      L378.1,449.1z"/>
    <path @click="pickCountry('CZ')" id="CZ" class="st0" d="M442.9,400.5l2.1-0.4l-0.1-1.9l3.3,0.8l0.3,1.1l1,1.1l4.6,1.1l2.7,1.1l0.8,0.9l3.2-0.7l1.8,1.2
    ...
    <path @click="pickCountry('DE')" id="DE" class="st0" d="M431.9,355.2l-3.4-0.1l-0.2-1.7l-1.1-1l-0.1-1l4.7,2.6L431.9,355.2z M397.1,347.1h-1.8l-1.4-0.7l0.8-1
    ...
    <path @click="pickCountry('DK')" id="DK" class="st0" d="M397.5,340l2.1,1l2.4,0.3l0.4,1.9l-3.5,0.7l-5.1-2.1l0.1-2.5l2.3-0.2L397.5,340L397.5,340z
    ...
    <path @click="pickCountry('EE')" id="EE" class="st0" d="M519.5,285.3l3.9,0.2l4,1.8l-1.8,0.7l-3.7,2.5l-0.3,0.5l-2.6-0.1l-1.4,0.2l-1,0.9l-0.9,2.8l-1.6,0.5
    ...
    <path @click="pickCountry('FI')" id="FI" class="st0" d="M510.5,260l2,0.2l-0.6,2.8l-2.3-1.8L510.5,260L510.5,260z M508.6,260.5l-2.1-0.6l0.9-0.8L508.6,260.5
    ...
    <path @click="pickCountry('GB')" id="GB" class="st0" d="M253.1,403.1l-1.6,1.3l-1.3,0.2l-2.5-1.2v-0.5l2.5-1.1l2,0.6L253.1,403.1z M216.6,363.4l1.3,0.9
    ...
    <path @click="pickCountry('GE')" id="GE" class="st0" d="M836.9,547.7l-2.3,0.5l0.5,0.7l-3.5,0.1l-1.1,0.2l-3.2-0.3l-5.3,1.3l-4.4,0.3l-1.3-1.2l-1.9-0.2
    ...
    <path @click="pickCountry('GR')" id="GR" class="st0" d="M576.9,637.7h2.3l1.7-1l2.2,3.7l1.7-0.1l3.5-0.9l3.7,0.2l1.4,1l2.6,0.2l2.3,0.5l3.3-0.7l0.4,0.4
    ...
    <path @click="pickCountry('HR')" id="HR" class="st0" d="M475.2,521.2l2.3,0.4l-1.1,0.9L475.2,521.2L475.2,521.2z M488.1,522.7l1.6-0.1l0.6,0.9l6.2,3.8l1.7,0.7
    ...
    <path @click="pickCountry('HU')" id="HU" class="st0" d="M535,437.8h1.5l1.4,2.3l2.2,0.8l0.9,1.1l2.3,0.4l0.9,0.7l0.7,1.7l-2.2,2.3l-4.6,1.1l-1.9,2.4l-1.2,1
    ...
    <path @click="pickCountry('IE')" id="IE" class="st0" d="M193.3,352l0.7,1.1l-2.2,0.4l1.5,5.2l0.6,0.9v4.1l0.9,3.2l0.1,2.5l-1.3,1.8l-0.9,2.1l-0.2,1.8l-1.6,2.1
    ...
    <path @click="pickCountry('IS')" id="IS" class="st0" d="M104.3,177.9l1.2,0.1l2.8-0.8l2.2-1.1l0.5,1.1l-2.5,2.4l2.2,0.9l2,0.3l-0.1,1.7l-1.7,1.6l0.8,0.3
      ...
      "/>
    <path @click="pickCountry('IT')" id="IT" class="st0" d="M466.6,595.6l-1.2,2.5l-2.8,4.3l-1.5,5.1l0.3,2l1.6,1.4l-0.7,0.5l1.6,1.8l0.1,1.3l-1.8,1.9l-0.4,1.7
    ...
    <path @click="pickCountry('LI')" id="LI" class="st0" d="M383.4,458.5l-1.2-0.1l-0.1-1.7l0.5-1.5l1.1,2.5L383.4,458.5L383.4,458.5z"/>
    <path @click="pickCountry('LT')" id="LT" class="st0" d="M571.9,328.5v1.8l-0.7,3.1l3.9,1l-1.3,1l-0.4,1.1l-3.6-0.1l-1,2L568,339l-2.6,0.6l-1.1,3l0.4,2.3
    ...
    <path @click="pickCountry('LU')" id="LU" class="st0" d="M339.4,411.7l0.3,2.2l1.5,1.6l2.8,1.1v1.4l-0.9,0.9l-0.6,3l-1.3-0.7l-2,0.6h-1.4l-2.1-1.2l1.1-1.7
      l-2-2.4l0.2-1.7l1.4-2.5l1.3-1.3L339.4,411.7z"/>
    <path @click="pickCountry('LV')" id="LV" class="st0" d="M575.6,301.2l1.9,0.3l0.5,1.1l3.2,1.7l0.7,2.2l-0.8,1.6l-0.3,3.1l1.8-0.3l1,0.6l0.3,1.2l1.7,2.1
    ...
    <path @click="pickCountry('MD')" id="MD" class="st0" d="M615.4,483.2l-2-2.3l0.9-0.7l-1.4-5l-0.1-2.6l0.9-4.8l-0.5-2.9l-1.4-2.3l-1.4-2.9l-3-2.1l-1.3-1.7
    ...
    <path @click="pickCountry('MK')" id="MK" class="st0" d="M547.8,531.8l3.3,3.2l3.4,1.8l1.7,3.3l0.9,1l-0.5,1.7v4.2l-2,0.3l-0.2,2.1l-2.9,1l-3.3-0.6l-3,0.4
      ...
      L547.8,531.8z"/>
    <path @click="pickCountry('ME')" id="ME" class="st0" d="M506.4,512.9l0.4,1.2l2.6,1.7l1.9,2l3,1.6l2.1,0.5l5.3,2.9l0.1,1l-1.6,0.4l-0.2,0.7l-2,0.4l0.9,1.5
      ...
      L506.4,512.9z"/>
    <path @click="pickCountry('NO')" id="NO" class="st0" d="M322,260.9l0.1,1.7l-1-0.1l-0.7-1.1l-0.2-2l0.7-0.5L322,260.9z M320.2,249.8h-1.8l0.3-1.3l0.9-0.3
    ...
    <path @click="pickCountry('PL')" id="PL" class="st0" d="M530.8,348l0.6-0.6l2.3,0.7l4.5,2.2l1.1,0.9l0.8,3l2.1,5.1l2.9,4.9l1.7,3.6l0.9,3.9l-0.6,1.6l-4,1.7
    ...
    <path @click="pickCountry('PT')" id="PT" class="st0" d="M170,611.9l-1.2,0.2l-4.5,2.5H163l-2.5-1.1l-4.5-0.4l-1.5-0.3l-1.8,0.7h-1.5l-1.1,1l-0.8-0.3l1-2.1
      ...
      />
    <path @click="pickCountry('RO')" id="RO" class="st0" d="M615.4,483.2l1.5,1.6l1.8,0.9l4,0.9l0.6-1.2l0.9,0.3l1.6-0.5l2.2-1.3l2.2-0.2l2.2,0.7l1.9,1.8l-0.2,4.3
    ...
    <path @click="pickCountry('RS')" id="RS" class="st0" d="M515.6,473.1l1.7,2l2.9,1.7l1.8,2l0.8-0.2l0.4,4.1l2.2,1.8l3.8,1.9l2.6,0.8l0.9,1.1l-1.5,2l2.3,1.1
    ...
    <path @click="pickCountry('SK')" id="SK" class="st0" d="M538.8,427.7l-1.5,3l-0.8,2.9l-1.6,1.7l0.1,2.5l-4.3,1.1l-0.6-0.2l-2.2-2.2l-1.4-0.9l-4.6,0.7l-2.5-0.6
    ...
    <path @click="pickCountry('SI')" id="SI" class="st0" d="M469.2,467.1l-2.5-0.6l-0.9,0.8v1.7h-2l-0.7,1l-4.4,1.7l-0.4,1.4l0.9,0.9l0.2,2.2l-0.4,1.1l-2.1,0.6
      ...
      L469.2,467.1z"/>
    <path @click="pickCountry('SE')" id="SE" class="st0" d="M455.1,319.4l-1.5-0.3l-0.3-3.8l2-4.6l1-0.3l2.7-6.5l0.5,2l-1.5,3.2l-0.3,2.2l-0.6,0.5L455.1,319.4
    ...
    <path @click="pickCountry('TR')" id="TR" class="st0" d="M597.4,565.7l-2.9,0.5l-0.1-1.5l2.2-0.6L597.4,565.7z M791.9,544.2l4.3,1.3l1.1-1l3.6,0.1l3.4,0.8
      ...
      L620,537.1z"/>
    <path @click="pickCountry('UA')" id="UA" class="st0" d="M660.7,471.6v0.6l-3.9-0.8l-0.9-0.9L660.7,471.6L660.7,471.6z M634.3,486.2l-1.9-1.8l-2.2-0.7l-2.2,0.2
    ...
    <path @click="pickCountry('XK')" id="XK" class="st0" d="M538,532.8l-2.1,0.4l-1.5,1.9l-1.6-1.2l-1,0.1l-3.4,1.5l-0.2,2.6l-0.5,0.8l-1.7-0.3l-0.1-2.2l-1.4-3.2
    ...
    <path @click="pickCountry('NL')" id="NL" class="st0" d="M316.2,392.5l-0.6,1.2l-3.2,1.5l-3.9-1.1l-1.2,0.6l-1.2-0.7l-0.3-1.3l2.8-0.4l3.5,0.7l1.5-0.6l1.2,0.5
    ...
    <path @click="pickCountry('ES')" id="ES" class="st0" d="M284.4,584.7l-0.4,1l-2-0.4v-1.5l1.2-1.6l2.7-0.7l0.8,1.3L284.4,584.7L284.4,584.7z M306.1,571.1
    ...
    <path @click="pickCountry('FR')" id="FR" class="st0" d="M385.2,524.1l-0.3,2.3l1,1.7l0.6,6.5l-1.8,3.2l0.1,3l-1.6,4.3l-0.8,1.1l-3.8-2l-1.2-1.1l1-1.8l-2.2-0.9
      ...
      L335.7,420.6z"/>
    <path @click="pickCountry('PT')" id="PT" class="st0" d="M170,611.9l-1.2,0.2l-4.5,2.5H163l-2.5-1.1l-4.5-0.4l-1.5-0.3l-1.8,0.7h-1.5l-1.1,1l-0.8-0.3l1-2.1l1.6-4.1
    ...
    <path @click="pickCountry('CY')" id="CY" class="st0" d="M707.2,646.3L707.2,646.3H707H707.2L707.2,646.3z M707.2,646.3L707.2,646.3h0.2l0.1,0.1h-0.1
