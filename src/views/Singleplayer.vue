...
<div class="c-game__map">
  ...
  <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <path id="FR" class="st0" d="M385.2,524.1l-0.3,2.3l1,1.7l0.6,6.5l-1.8,3.2l0.1,3l-1.6,4.3l-0.8,1.1l-3.8-2l-1.2-1.1l1-1.8l-2.2-0.9
      ...
      L335.7,420.6z"/>
    <path class="st0" d="M170,611.9l-1.2,0.2l-4.5,2.5H163l-2.5-1.1l-4.5-0.4l-1.5-0.3l-1.8,0.7h-1.5l-1.1,1l-0.8-0.3l1-2.1l1.6-4.1
...
<div class="c-game__footer">
  POINT AT  <span class="pointAtCountry">PORTUGAL</span>
</div>
</div>
